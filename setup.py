...
def main():
    ...
    setup(
        name="ctodd-python-lib-threading",
        version=version,
        python_requires=">3.0,<3.7",
        description=("Python utilities used for Threading in Python"),
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-threading",
        author="Christopher H. Todd",
        author_email="Christopher.Hayden.Todd@gmail.com",
        classifiers=["Programming Language :: Python"],
        keywords=["python", "libraries", "threads", "muti-thread"],
        packages=packages,
